      ...
      children: [
        {
          name: "数据报表",
          key: "ibi-1",
          path: "/reportCenter/data",
        },
        {
          name: "图形报表",
          key: "ibi-2",
          path: "/reportCenter/chart",
        },
        {
          name: "打印报表",
          key: "ibi-3",
          path: "/reportCenter/print",
        }
      ]
    },
    {
      ...
      children: [
        {
          name: "分享记录",
          key: "cm-1",
          path: "/reportCenter/share",
        },
        {
          name: "导出记录",
          key: "cm-2",
          path: "/reportCenter/export",
        },
        {
          name: "定时导出",
          key: "cm-3",
          path: "/reportCenter/schedule",
        }
      ]
    },
    {
      ...
      key: "research",
      icon: "icon-daochu1",
      path: "/reportCenter/dataset",
    },
    {
      name: "回收站",
      key: "finance",
      icon: "icon-shanchu",
      path: "/reportCenter/recycle",
    }
  ],
});
